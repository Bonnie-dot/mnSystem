    ...
    <Layout>
      ...
      <Layout>
        ...
        >
          <Menu :open-names="['1']" active-name="1" theme="dark" width="auto">
            ...
            <Submenu name="2">
              ...
              <MenuItem name="2-1">
                <nuxt-link to="/article/article-list">
                  <span>文章列表</span>
                </nuxt-link>
              </MenuItem>
              <MenuItem name="2-2">
                <nuxt-link to="/article/article-add">
                  <span>新增文章</span>
                </nuxt-link>
              </MenuItem>
            </Submenu>
            ...
            <Submenu name="5">
              ...
              <MenuItem name="3-1">
                <nuxt-link to="/userInfo">信息修改</nuxt-link>
              </MenuItem>
            </Submenu>
          </Menu>
        </Sider>
        <Layout :style="{padding: '0 24px 24px 228px'}">
          ...
          <Content :style="{padding: '24px', minHeight: '858px', background: '#fff'}">
            <nuxt/>
          </Content>
        </Layout>
      </Layout>
